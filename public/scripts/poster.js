...
(function (global) {
    ...
    function renderFighterSlot(m, side, size, showResults, options, matchKey) {
        ...
        return (
            '<div class="gala-fighter gala-fighter--' + corner + ' gala-fighter--' + size + cc + clickClass + '"' + dataAttrs + '>' +
                ...
                '<div class="gala-photo"' + photoStyle(f) + '></div>' +
    ...
    function renderBoutCorner(m, side, showResults, options, matchKey) {
        ...
        return (
            '<div class="gala-bout-corner gala-bout-corner--' + corner + cc + (interactive ? ' gala-fighter--interactive' : '') + '"' + dataAttrs + '>' +
                ...
                '<div class="gala-bout-photo"' + photoStyle(f) + '></div>' +
    ...
    function buildUfcPosterHtml(matches, options) {
        ...
        var html = '<div class="gala-poster gala-poster--ufc' + modeClass + '">';

        html += '<header class="gala-header gala-header--compact">';
        html += '<div class="gala-header-compact-inner">';
        html += '<span class="gala-dot-label"><i class="gala-dot gala-dot--red"></i> ROUGE</span>';
        html += '<div class="gala-header-center">';
        html += '<h1 class="gala-title gala-title--compact">' + escapeHtml(EVENT_TITLE) + ' <span class="gala-edition">' + escapeHtml(EVENT_EDITION) + '</span></h1>';
        html += '<p class="gala-date gala-date--compact">' + escapeHtml(EVENT_DATE) + '</p>';
        if (showResults) html += '<p class="gala-subtitle-results">RÉSULTATS</p>';
        html += '</div>';
        html += '<span class="gala-dot-label"><i class="gala-dot gala-dot--blue"></i> BLEU</span>';
        html += '</div></header>';
        ...
        if (options.includeWaiting !== false && waiting.length) {
    ...
    function buildPosterHtml(matches, options) {
        ...
        var html = '<div class="gala-poster gala-poster--galapro' + modeClass + '">';
        ...
        html += '</div>';
        html += '<h1 class="gala-title"><span class="gala-crown" aria-hidden="true">♛</span> ' + escapeHtml(EVENT_TITLE) + ' <span class="gala-edition">' + escapeHtml(EVENT_EDITION) + '</span></h1>';
